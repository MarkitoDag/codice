...
import 'package:sistema_gestione_comune/login/Log_in_BLoc.dart';
...
class _Log_inState extends State<Log_in> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Gestione comune'),
      ),
      body: BlocProvider(
    ...
    return BlocBuilder<LoginBloc, LoginState>(builder: (context, state) {
      return TextFormField(
          ...
          decoration: const InputDecoration(
              icon: Icon(Icons.person), hintText: 'Numero addetto'),
          validator: (value) => state.isValidCodiceFiscale
              ? null
